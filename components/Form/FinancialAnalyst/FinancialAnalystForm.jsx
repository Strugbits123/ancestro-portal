...
//   const [showThankYou, setShowThankYou] = useState(false);
//   const [hasTriedNext, setHasTriedNext] = useState(false); // This fixes the language bug
...
//   } = useForm({
//     mode: "onChange",
//     // reValidateMode: "onChange" → REMOVED! This was causing errors on language change
//   });
...
//       setStep(1);
//       setShowThankYou(false);
//       setHasTriedNext(false); // Reset this too
//       Object.values(refs).forEach((r) => r.current && (r.current.value = ""));
...
//       clearErrors(); // Clean UX
//     }
//   };

//   const prevStep = () => {
//     setStep((prev) => Math.max(prev - 1, 1));
//     setHasTriedNext(false); // Hide errors when going back
//   };
...
//                         <h2 className="text-xl font-bold uppercase text-[#F8B03B] text-center mb-10 tracking-wider">
//                           {t(`forms.financialAnalyst.steps.step${step}`)}
//                         </h2>
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.fullName"
//                                 )}
//                                 name="fullName"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.location"
//                                 )}
//                                 name="location"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.whatsapp"
//                                 )}
//                                 name="whatsapp"
//                                 register={register}
//                                 required
...
//                               />
//                               <Input
//                                 label={t("forms.financialAnalyst.fields.email")}
//                                 name="email"
//                                 register={register}
//                                 required
//                                 type="email"
...
//                               />
//                               <Input
//                                 label={t("forms.financialAnalyst.fields.dob")}
//                                 name="dob"
//                                 register={register}
//                                 required
//                                 type="date"
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.languages"
//                                 )}
//                                 name="languages"
//                                 register={register}
//                                 required
...
//                                 <Input
//                                   label={t(
//                                     "forms.financialAnalyst.fields.linkedin"
//                                   )}
//                                   name="linkedin"
//                                   register={register}
//                                   errors={errors}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.education"
//                                 )}
//                                 name="education"
//                                 register={register}
//                                 required
...
//                               <FileUpload
//                                 label={t(
//                                   "forms.financialAnalyst.fields.certifications"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.yearsExperience"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.renewableExperience"
//                                 )}
...
//                               <FileUpload
//                                 label={t(
//                                   "forms.financialAnalyst.fields.uploadCV"
//                                 )}
//                                 required
//                                 fileName={cvFileName}
//                                 onChange={(e) => {
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.softwareTools"
//                                 )}
//                                 name="softwareTools"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.modelInfluence"
//                                 )}
//                                 name="modelInfluence"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.cashFlowApproach"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.profitabilityKPIs"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.sensitivityAnalysis"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.intlVariables"
//                                 )}
//                                 name="intlVariables"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.forecastingExperience"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.dataIntegrity"
//                                 )}
//                                 name="dataIntegrity"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.investorReports"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.communicationStyle"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.documentationType"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.hiddenOpportunity"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.profitVsImpact"
//                                 )}
//                                 name="profitVsImpact"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.projectFinancing"
//                                 )}
...
//                                 {t(
//                                   "forms.financialAnalyst.sections.visionPurpose"
//                                 )}
//                               </p>
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.whyAncestro"
//                                 )}
//                                 name="whyAncestro"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.latamTransformation"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.gridExcitement"
//                                 )}
//                                 name="gridExcitement"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.financeTechSpirit"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.roleInMission"
//                                 )}
//                                 name="roleInMission"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.longTermGoals"
//                                 )}
//                                 name="longTermGoals"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.startAvailability"
//                                 )}
...
//                               <p className="text-sm -mt-8 mb-[10px] sm:text-[18px] px-2.5 py-[5px] mx-auto rounded-[10px] w-max border border-[#FFFFFF1A] uppercase">
//                                 {t(
//                                   "forms.financialAnalyst.sections.lifestyleMindset"
//                                 )}
//                               </p>
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.selfDiscipline"
//                                 )}
//                                 name="selfDiscipline"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.dailyHabits"
//                                 )}
//                                 name="dailyHabits"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.habitImproving"
//                                 )}
//                                 name="habitImproving"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.mentalFatigue"
//                                 )}
//                                 name="mentalFatigue"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.mindfulnessPractice"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.selfTalkUnderPressure"
//                                 )}
...
//                               <p className="text-sm -mt-8 mb-[10px] sm:text-[18px] px-2.5 py-[5px] mx-auto rounded-[10px] w-max border border-[#FFFFFF1A] uppercase">
//                                 {t(
//                                   "forms.financialAnalyst.sections.motivationPurpose"
//                                 )}
//                               </p>
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.currentBlock"
//                                 )}
//                                 name="currentBlock"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.traditionalFinanceFrustration"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.satisfyingWork"
//                                 )}
//                                 name="satisfyingWork"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.whyConsciousFinance"
//                                 )}
...
//                               <p className="text-sm -mt-8 mb-[10px] sm:text-[18px] px-2.5 py-[5px] mx-auto rounded-[10px] w-max border border-[#FFFFFF1A] uppercase">
//                                 {t(
//                                   "forms.financialAnalyst.sections.personalityComm"
//                                 )}
//                               </p>
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.energyType"
//                                 )}
//                                 name="energyType"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.presentationComfort"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.learningOpenness"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.independenceVsTeam"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.idealEnvironment"
//                                 )}
...
//                               <p className="text-sm -mt-8 mb-[10px] sm:text-[18px] px-2.5 py-[5px] mx-auto rounded-[10px] w-max border border-[#FFFFFF1A] uppercase">
//                                 {t(
//                                   "forms.financialAnalyst.sections.growthCulture"
//                                 )}
//                               </p>
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.spiritualTeamValue"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.energyMaintenance"
//                                 )}
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.personalGrowth"
//                                 )}
//                                 name="personalGrowth"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.fitnessSupport"
//                                 )}
//                                 name="fitnessSupport"
//                                 register={register}
//                                 required
...
//                               <Input
//                                 label={t(
//                                   "forms.financialAnalyst.fields.fitnessChallenge"
//                                 )}
...
//                               <FileUpload
//                                 label={t(
//                                   "forms.financialAnalyst.fields.personalPhoto"
//                                 )}
...
//                               <FileUpload
//                                 label={t(
//                                   "forms.financialAnalyst.fields.finalUploadCV"
//                                 )}
//                                 required
...
//                               <FileUpload
//                                 label={t(
//                                   "forms.financialAnalyst.fields.uploadVideo"
//                                 )}
...
//                               <RadioCheckbox
//                                 label={t(
//                                   "forms.financialAnalyst.fields.fullTimeAvailability"
//                                 )}
...
//                               <RadioCheckbox
//                                 label={t(
//                                   "forms.financialAnalyst.fields.trainingCommitment"
//                                 )}
//                                 options={[t("common.yes"), t("common.no")]}
...
//                             }`}
//                           >
//                             {t("forms.financialAnalyst.submitButton")}
//                           </button>
//                         )}
//                       </div>
//                     </div>
...
//         isOpen={showThankYou}
//         onClose={handleClose}
//         text1={t("forms.financialAnalyst.thanks.text1")}
//         text2={t("forms.financialAnalyst.thanks.text2")}
//       />
//     </>
//   );
// }
...
//               {value === option && (
//                 <div className="w-4 h-4 bg-[#F8B03B] rounded-sm" />
//               )}
//             </div>
...
import { financialAnalystConfig } from "./financialAnalystConfig";
import FormBuilder from "../FormBuilder"; // a generalized form component

export default function FinancialAnalystModal({ isOpen, onClose }) {
  return (
    <FormBuilder
      isOpen={isOpen}
      onClose={onClose}
