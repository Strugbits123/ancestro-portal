      ...
      <section className="relative  h-auto bg-black w-full overflow-hidden">
        ...
        <div className='flex flex-col gap-y-[80px] w-full'>
          <div className="relative sm:px-10  max-sm:!px-5 ">
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col items-center justify-center px-6 sm:px-10 lg:px-20 xl:px-52">
                <div className="bg-[#F8B03B4D] border border-[#F8B03B] px-2.5 py-[2px] mb-8 max-sm:mt-6 rounded-md">
                  <p className="font-helvetica font-normal max-sm:text-center text-[16px] lg:text-[20px] tracking-[2px] text-white uppercase">
                ...
                <div className="space-y-6 max-w-[1080px] text-center">
          ...
          <div className="relative  sm:-mt-28 lg:-mt-32 xl:-mt-10 px-5 sm:px-10 lg:px-20 xl:px-48 2xl:px-64">
            ...
            >
              <div className="bg-[#F8B03B4D] border border-[#F8B03B] px-2.5 py-[2px] mb-8 inline-block rounded-md">
                <p className="font-helvetica font-normal text-[16px] sm:text-[20px] tracking-[2px] text-white uppercase">
